...
export default function DoubleTemplateSymmetric() {
  return (
    <div className="w-full h-full p-20 flex items-stretch justify-between gap-8">
      {/* 왼쪽 캐릭터 */}
      <div className="flex-1 flex items-start justify-between gap-6 min-w-0">
        ...
        <div className="w-[240px] h-full flex flex-col items-center gap-6 shrink-0">
          <div className="w-full rounded-2xl h-14 overflow-hidden bg-neutral-100 shadow-md">
            <TemplateZone slotId="double2-a-text" placeholder="A 텍스트" />
          </div>

          <div className="w-full h-[250px] min-h-[250px] rounded-full overflow-hidden bg-neutral-100 shadow-md">
            <TemplateZone
          ...
          <div className="w-full rounded-2xl min-h-[120px] overflow-hidden bg-neutral-100 shadow-md">
            <TemplateZone
        ...
        <div className="flex-1 h-full flex flex-col items-center gap-8 min-w-0">
          <div className="w-full flex-1 min-h-0 rounded-3xl overflow-hidden bg-neutral-100 shadow-md">
            <TemplateZone slotId="double2-a-full" placeholder="A 전신 이미지" />
          </div>

          <div className="w-full h-[230px] rounded-2xl overflow-hidden bg-neutral-100 shadow-md">
