    ...
    <div className="w-full h-full p-20 flex flex-col gap-8 overflow-hidden">
      ...
      <div className="flex gap-8 h-[680px]">
        <div className="flex-1 flex flex-col gap-4">
          <div className="h-20 rounded-lg bg-neutral-100 shadow-md overflow-hidden">
            <TemplateZone slotId="portrait-name" placeholder="이름 / 타이틀" />
          </div>
          <div className="flex-1 min-h-0 rounded-lg overflow-hidden bg-neutral-100 shadow-md">
            <TemplateZone slotId="portrait-main" placeholder="대표 이미지" />
          </div>
        </div>
        <div className="w-[400px] rounded-lg overflow-hidden bg-neutral-100 shadow-md">
          <TemplateZone slotId="portrait-sub" placeholder="전신 / SD" />
        </div>
      </div>

      {/* 중단: 팔레트 영역 */}
      <div className="h-[180px] rounded-2xl bg-neutral-100 shadow-md overflow-hidden">
      ...
      <div className="grid grid-cols-3 gap-6 flex-1 min-h-0">
        {(
          ...
          <div
            key={slotId}
            className="rounded-xl bg-neutral-100 shadow-md overflow-hidden"
          >
